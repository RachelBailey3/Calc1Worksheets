...
\begin{question}
Find the domains of the following functions and state them in interval notation.
\begin{enumerate}
\item $\displaystyle\frac{\ln(x-2)}{x^2-6x-7}=$\wordChoice{
                \choice[correct]{$($}
                \choice{$[$}
                \choice{$)$}
                \choice{$]$}
                }=$\answer{2},\answer{7}$\wordChoice{
                \choice{$($}
                \choice{$[$}
                \choice[correct]{$)$}
                \choice{$]$}
                ...
                \choice[correct]{$)$}
                \choice{$]$}
                } $\answer{7},\answer{\infty}$\wordChoice{
                \choice{$($}
                \choice{$[$}
                \choice[correct]{$)$}
                \choice{$]$}
                }
\item $\displaystyle\frac{x^2+1}{\sqrt{3x-1}}$
\item $\ln(x^2-3x-4)$
\end{enumerate}
